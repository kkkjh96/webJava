package com.myspring.pro301.common.log;
...
public class LoggingAdvice {
	...
	@Before("execution(* com.myspring.pro301.*.service.*.*(..)) or " + "execution(* com.myspring.pro301.*.dao.*.*(..))")
	...
	@After("execution(* com.myspring.pro301.*.service.*.*(..)) or " + "execution(* com.myspring.pro301.*.dao.*.*(..))")
...
//	@Around("execution(* com.myspring.pro301.*.service.*.*(..)) or " + "execution(* com.myspring.pro301.*.dao.*.*(..))")
